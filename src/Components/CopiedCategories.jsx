export default function CopiedCategories({ categories }) {
    ...
    const totalCount = categories.reduce((acc, category) => acc + flattenCategories(category), 0)
  
    return (
      <div className="mt-8 border-2 border-blue-300 rounded-lg p-4">
        <h2 className="text-xl font-bold mb-4">Copied Categories (Total: {totalCount})</h2>
